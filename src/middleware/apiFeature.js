...
const filterAndSort = (req, res, next) => {
  ...
  if ('owner' in req.sort) { // Changed from 'author' to 'owner'
    req.sort.owner = req.sort.owner // Changed from req.sort.author to req.sort.owner
...
const list = (req, res, next) => {
  ...
  req.fields == undefined ? (req.fields = fields) : (req.fields = Object.assign(req.fields, fields)) // Changed === to ==
  next()
}
